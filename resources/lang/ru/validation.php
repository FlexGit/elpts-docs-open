...
return [
    ...
    */
    ...
    'attributes' => [
		...
		'doc_field84' => '<a href="#doc_field84">"Заключение Минпромторг"</a>',
		'doc_field85' => '<a href="#doc_field85">"Адрес для отправки бухгалтерских документов (необходимо указать полный почтовый адрес)"</a>',
